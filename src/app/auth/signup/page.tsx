...
export default function SignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate signup & redirect to onboarding placement test
    setTimeout(() => {
      setStats({
        ...stats,
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="bg-white dark:bg-[#0c0c0e]/80 border border-neutral-200 dark:border-neutral-800 rounded-3xl p-6 md:p-8 shadow-xl space-y-6">
          ...
          <div className="text-center space-y-1">
            ...
            <h1 className="text-xl font-bold tracking-tight">Create your NihonPath Account</h1>
            <p className="text-xs text-neutral-500">Unlock your ultimate structured Japanese roadmap</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-neutral-400 uppercase tracking-wide">Learner Name</label>
              <input
                type="text"
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-neutral-400 uppercase tracking-wide">Create Password</label>
            ...
            <div className="flex items-start gap-2 pt-1">
              <input
                ...
                className="mt-1 accent-rose-600 rounded border-neutral-300 dark:border-neutral-800 bg-transparent focus:ring-rose-500/30"
              />
              <label htmlFor="terms" className="text-xs text-neutral-500 leading-normal font-semibold">
                I agree to the{' '}
                <a href="#" className="font-bold text-rose-500 hover:underline">Terms of Service</a> and{' '}
                <a href="#" className="font-bold text-rose-500 hover:underline">Privacy Policy</a>.
              </label>
            </div>
          ...
          <div className="flex items-center gap-3 py-2">
            ...
            <span className="text-[10px] font-bold text-neutral-400 uppercase">Or register with</span>
            <div className="h-[1px] flex-1 bg-neutral-200 dark:bg-neutral-800" />
          </div>
          ...
          <p className="text-center text-xs text-neutral-500">
            ...
            <Link href="/auth/login" className="font-bold text-rose-500 hover:text-rose-600">
              Sign In
            </Link>
          </p>
        </div>
